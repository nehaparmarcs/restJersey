...
public class CheckInsJerseyClient {
	...
	public static WebResource webResource = client.resource("http://localhost:8080/restJersey/rs/rest/checkin/register");
		
	
	static MongoClient mongoClient = getMongoClient();
